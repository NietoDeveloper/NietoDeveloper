...
| <a href="https://digitaltwinvideo.vercel.app/" target="_blank">Video Digital Twin APP</a> | `MERN` `TS` `Docker` `AWS` | 🟠 **ArquitectureFase** | Real-time industrial video monitoring |
