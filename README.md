...
| **[Software DT: DashBoard For Drone](https://softwaredt.vercel.app/)** | `Next.js` `Real-time` | 🆕 Next Proyect | **Digital Twin:** Real-time digital replica and industrial control center. |
| **[Drone DT (Shop)](https://dronedt.vercel.app/)** | `Next.js 15` `TS` | 🟡 Construction | E-Commerce and store for Drone Factory. |
| **[Emerald DT](https://emeraldsdt.netlify.app/)** | `Next.js` `Node JS` `REACT` `Mongo DB` `AWS` `PostgreSQL` `Docker` | 🟠 Development | High-Value Asset Management System for Industrial Scale. E-Commerce |
