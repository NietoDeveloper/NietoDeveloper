...
| [Drone DT: DashBoard](https://dashboarddronedt.vercel.app/) | `MERN` `TS` `AWS` `Docker` `SQL` | 🟡 Construction | Management System For E-Commerce |
| [Emerald DT](https://emeralddt.vercel.app/en) | `Next.js` `TS` `Docker` `AWS` | 🟢 MVP Ready | High-Value Asset Management & E-Commerce |
| [Emerald DT: DashBoard](https://emeralddt.vercel.app/) | `Node.js` `TS` `Docker` `AWS` | 🟡 Construction | Management System For Assets & Operations |
...
<p align="center">
  <strong>Last Updated: September 21, 2026</strong>
</p>
